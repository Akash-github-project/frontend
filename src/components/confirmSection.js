...
function ConfirmSection({ heading, data = [], type, submitLink = "/#" }) {
  ...
  return (
    <div className="w-[26rem] grid gap-1 p-px bg-white mt-1">
      ...
      <button
        className="  leading-xs text-[13px] ml-auto mr-auto h-[34px] font-medium inline-block capitalize text-white bg-pink-primary px-4  max-w-fit hover:pink-700 rounded"
